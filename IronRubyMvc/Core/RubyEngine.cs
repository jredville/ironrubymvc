...
namespace System.Web.Mvc.IronRuby.Core {
    ...
    public class RubyEngine : IRubyEngine {
        ...
        private void Initialize() {
            ...
            Context = Microsoft.Scripting.Hosting.Providers.HostingHelpers.GetLanguageContext(Engine) as RubyContext;
            CurrentScope = Engine.CreateScope();
            Operations = Engine.CreateOperations();
            LoadAssemblies(typeof(object), typeof(Uri), typeof(HttpResponseBase), typeof(System.Web.Security.MembershipCreateStatus),
